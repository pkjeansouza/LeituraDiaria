 ...
 */
	Configure::write('Session', array(
		'defaults' => 'php',
        'cookie' => 'LeituraDiaria'
	));

/**
 * A random string used in security hashing methods.
 */
	Configure::write('Security.salt', 'ebd03e28cf0382b73cdd7735bdfdb8513fc99a7c');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '376397945451823357619791906531');
